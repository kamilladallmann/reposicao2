                  ...
                  <div class="col">
                      <form action="/requerimento/alterar" method="post">
                          ...
                          <div class="form-group">
                              ...
                              <select value="${(requerimentoAtual.departamento.id)!}"name="departamento.id" id="departamento.id" class="form-control" required>
                                   <option value="" disabled>Selecione uma opção</option>
                                   <#list departamentos as departamento>
                                        <option value="${departamento.id}" <#if (departamento.id == requerimentoAtual.departamento.id)> selected="selected"</#if>>${departamento.nome}</option>
                                   </#list>
                              </select>
                          </div>
